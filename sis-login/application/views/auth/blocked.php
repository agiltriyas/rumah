...
<head>
    ...
    <link href="<?= base_url('asets/') ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<?= base_url('asets/') ?>css/sb-admin-2.min.css" rel="stylesheet">
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 mb-0">It looks like you found wrong room...</p>
